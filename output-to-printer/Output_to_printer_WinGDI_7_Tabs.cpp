...
// Output_to_printer_WinGDI_7_Tabs.cpp
...
// (добавляем вставку вместо символов табуляции '\t' пробелов '\x2002' (en space)
// в количестве 8 штук; именно такие пробелы — чтобы не растягивались при выравнивании
// по обеим сторонам)
